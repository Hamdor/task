...
test: download
	...
	$(CC) $(CCFLAGS) $(CC_SANITIZER_1_FLAGS) $(INCLUDE) -Itests tests/catch_main.cpp tests/index_table_test.cpp tests/atomic_queue_test.cpp \
	...
	$(CC) $(CCFLAGS) $(CC_SANITIZER_2_FLAGS) $(INCLUDE) -Itests tests/catch_main.cpp tests/index_table_test.cpp tests/atomic_queue_test.cpp \
